...
O referencial teórico e uma descrição da metodologia do 4MD pode ser encontrada [neste link.](https://www.epe.gov.br/sites-pt/publicacoes-dados-abertos/publicacoes/PublicacoesArquivos/publicacao-607/topico-593/NT_Metodologia_4MD_PDE_2031.pdf)
...
No local onde o pacote é instalado na máquina existe a pasta `dados_premissas`. Dentro dessa pasta há subpastas com dados e parâmetros de entrada para cada edição do Plano Decenal de Expansão de Energia (PDE). 
```{r}
list.files(system.file("dados_premissas/2021", package = "epe4md"))
```
...
### base_mmgd_ajuste2022.xlsx

É a base tratada de sistemas de MMGD instalados em janeiro e fevereiro de 2022. A base é utilizada com a função `epe4md_ajuste_2022` para realizar a projeção de referência do PDE 2032.
